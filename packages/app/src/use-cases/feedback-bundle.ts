import type { ApprovalGate, CommentReply, ReviewStatus } from '@mdloop/domain';
import { deriveReviewStatus, replyDepth } from '@mdloop/domain';
import type { DocumentId, ReplyId, Result, UserId } from '@mdloop/shared';
import { ok } from '@mdloop/shared';
import type {
...
export interface FeedbackBundle {
  ...
  /**
   * Sign-off picture (Phase B) — so an agent knows whether it holds the mdloop:
