import type { GrantablePermission, ShareGrant } from '@mdloop/domain';
import { isGuestGrantable } from '@mdloop/domain';
import type { GrantId, ProjectId, Result, UserId } from '@mdloop/shared';
