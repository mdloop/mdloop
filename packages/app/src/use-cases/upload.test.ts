...
import { MAX_UPLOAD_BYTES } from '@vorlyn/domain';
import type { DocumentId, ProjectId, UserId } from '@vorlyn/shared';
import {
...
/**
 * Workspace paths (Phase 29). `path` is display metadata that lets Vorlyn
