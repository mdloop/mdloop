...
import type { GuestCapError, Permission, ShareGrant } from '@mdloop/domain';
import {
...
import type { DocumentId, OrgId, Result, UserId } from '@mdloop/shared';
...
import type { GuestGrantablePermission } from '@mdloop/domain';
 ...
 * recipient has no mdloop account, so a synthetic `guest` user row backs the
