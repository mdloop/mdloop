 ...
 * cache, `.mdloop/manifest.json` stays the source of truth for any folder
...
/** Every folder this data directory has ever auto-linked — `mdloop projects list`'s data source. */
