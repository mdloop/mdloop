-- Phase B: sign-off workflow ("pass the vorlyn"). A reviewer is requested on a
...
grant select, insert, update on review_requests to vorlyn_app;
...
grant select, insert on approvals to vorlyn_app;
