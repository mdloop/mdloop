...
grant select, insert, update, delete on org_invites to vorlyn_app;
grant select, insert, delete on org_allowlist_entries to vorlyn_app;
...
-- existing `grant select ... on organizations to vorlyn_provisioner`).
grant select on org_invites to vorlyn_provisioner;
grant update (accepted_at) on org_invites to vorlyn_provisioner;
grant select on org_allowlist_entries to vorlyn_provisioner;
grant update (provisioning_mode, sso_connection_id) on organizations to vorlyn_provisioner;
