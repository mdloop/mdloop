...
grant select, insert, update, delete on api_keys to vorlyn_app;
...
grant select on api_keys to vorlyn_provisioner;
grant update (last_used_at) on api_keys to vorlyn_provisioner;
