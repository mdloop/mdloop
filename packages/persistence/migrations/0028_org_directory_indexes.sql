...
-- missing vorlyn_provisioner grant the storage-bytes aggregate needs.
--
-- vorlyn_provisioner already has select on organizations and users (0001), so
...
grant select on document_versions to vorlyn_provisioner;
