...
-- vorlyn_app appends from tenant-scoped purge paths; the provisioner appends
-- from system sweeps and reads for post-restore replay. Nobody deletes.
grant insert on erasure_log to vorlyn_app;
grant select, insert on erasure_log to vorlyn_provisioner;
