 ...
 * imports instead of the full `@vorlyn/persistence` barrel.
 *
 ...
 * `dist/cli/main.js` (esbuild inlines every `@vorlyn/*` module it reaches)
 * therefore only ever pulls in what `vorlyn open`/`vorlyn serve` actually
