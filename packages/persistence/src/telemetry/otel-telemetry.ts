...
import type { TelemetryEvent, TelemetryFields, TelemetryPort, TelemetrySpan } from '@mdloop/app';
...
export class OtelTelemetry implements TelemetryPort {
  private readonly tracer = trace.getTracer('mdloop');
  private readonly meter = metrics.getMeter('mdloop');
