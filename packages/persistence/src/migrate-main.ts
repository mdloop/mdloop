 ...
 * as the database owner (never vorlyn_login: DDL needs owner privileges
...
try {
  ...
  // Real deploy failure (2026-08-07): vorlyn_login is created by migration
  ...
  // (local/dev, trust socket) skips it entirely — vorlyn_login stays
  ...
  if (appLoginPassword) {
    ...
    console.log('synced vorlyn_login password'); // eslint-disable-line no-console
  }
} catch (e) {
