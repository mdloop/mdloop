...
import type { BlobUrlPort, VersionKey } from '@mdloop/app';
import { versionObjectKey } from '@mdloop/app';
...
export interface CloudFrontSignedBlobUrlConfig {
  ...
  /** PEM-encoded private key for `keyPairId`, e.g. from `mdloop/prod/cloudfront-signer`. */
