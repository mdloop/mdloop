...
import { decodeNameKeysetCursor, encodeNameKeysetCursor } from '@vorlyn/app';
import type { Organization, User, UserRole } from '@vorlyn/domain';
  ...
  implements OrganizationRepository, RoleDirectory, OrgLifecyclePort
{
   ...
   * touch a neighbour, and vorlyn_app's ordinary grants suffice. No
