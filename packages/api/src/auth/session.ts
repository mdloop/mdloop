...
import { GLOBAL_SESSION_MAX_MS } from '@mdloop/domain';
 ...
 * guard (see `@mdloop/domain` `effectiveSessionExpiry`). `iat` (issued-at) drives
...
export const SESSION_COOKIE = 'mdloop_session';
 ...
 */
export const CSRF_COOKIE = 'mdloop_csrf';
