...
import { actorForApiKey } from '@mdloop/app';
import {
  FsStorage,
  OtelTelemetry,
 ...
 *   MDLOOP_API_KEY=mdloop_... DATABASE_URL=... node packages/mcp/dist/stdio-main.js
...
const deps: McpDeps = {
  ...
  storage: new FsStorage(env.BLOB_STORAGE_DIR ?? '.mdloop-blobs'),
...
const actor = await actorForApiKey(deps.apiKeys, env.MDLOOP_API_KEY);
