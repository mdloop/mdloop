...
/**
 * Personal API keys — the credential `vorlyn link` / `vorlyn push` and MCP
    ...
    <section className="settings-section" aria-labelledby="api-keys-heading">
      ...
      <div className="settings-section-head">
        ...
        <p className="help-text">
          A key lets the <code>vorlyn</code> CLI and MCP clients act as you. Run{' '}
          <code>vorlyn link</code> in a repo and paste the key when it asks.{' '}
          {me.role === 'admin'
        ...
        <details className="settings-install-help">
          ...
          <p>
            ...
            <code>@vorlyn/cli</code> from source (
            <code>pnpm install &amp;&amp; pnpm typecheck</code>) and put{' '}
            <code>packages/cli/dist/main.js</code> on your <code>PATH</code> (or export{' '}
            <code>VORLYN_CLI_PATH</code>). Full flag reference: the CLI reference doc.
          </p>
          <p>
            <strong>MCP</strong> — for Claude Code, install the <code>vorlyn-sync</code> plugin (see
