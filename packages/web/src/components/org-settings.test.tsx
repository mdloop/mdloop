...
describe('OrgSettings API keys', () => {
  ...
  it('mints a key, reveals it once, and copies it', async () => {
    ...
    vi.mocked(api.createApiKey).mockResolvedValue({ key: 'vorlyn_supersecret', record });
    renderFor(member);
    ...
    expect(reveal.textContent).toContain('vorlyn_supersecret');
    ...
    expect(writeText).toHaveBeenCalledWith('vorlyn_supersecret');
